...
export default async function About() {
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-center font-bold text-[#FEFAE0] text-5xl pt-6 mb-20">
        What are Holland Codes?
      </h1>
      <div className="flex flex-col justify-center bg-[#606C3840] text-[#FEFAE0] text-3xl p-10">
      ...
      <div className="pt-8 px-4">
        ...
        <h2 className="text-[#FEFAE0] font-bold text-4xl pt-12 text-center">
          The 6 personalities
        </h2>
        <div className="flex flex-col justify-center pt-10">
          <h3 className="text-2xl text-[#FEFAE0]">Realistic (Doers)</h3>
          <p className="pt-5 text-[#DDA15E]">
            People who have athletic ability, prefer to work with objects,
            machines, tools, plants or animals, or to be outdoors.
          </p>
        </div>
        <div className="flex flex-col justify-center pt-10">
          <h3 className="text-2xl text-[#FEFAE0]">Investigative (Thinkers)</h3>
          <p className="pt-5 text-[#DDA15E]">
        ...
        <div className="flex flex-col justify-center pt-10">
          <h3 className="text-2xl text-[#FEFAE0]">Artistic (Creators)</h3>
          <p className="pt-5 text-[#DDA15E]">
        ...
        <div className="flex flex-col justify-center pt-10">
          <h3 className="text-2xl text-[#FEFAE0]">Social (Helpers)</h3>
          <p className="pt-5 text-[#DDA15E]">
        ...
        <div className="flex flex-col justify-center pt-10">
          <h3 className="text-2xl text-[#FEFAE0]">Enterprising (Persuaders)</h3>
          <p className="pt-5 text-[#DDA15E]">
        ...
        <div className="flex flex-col justify-center pt-10 mb-20">
          <h3 className="text-2xl text-[#FEFAE0]">Conventional (Organizers)</h3>
          <p className="pt-5 text-[#DDA15E]">
